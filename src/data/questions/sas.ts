...
// SAS specific questions
export const sasQuestions: FunnelQuestion[] = [
    {
      id: "business_type",
      type: "choice",
      ...
      helpText: "💡 Indicate whether you are creating an SAS or an SASU to allow us to personalize your process and your documents.",
      nextStep: (response) => response === "sasu" ? "sasu" : "company_name",
    },
    {
      id: "company_name",
      type: "text",
...
// ... Add all other SAS-specific questions here