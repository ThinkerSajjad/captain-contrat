        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-center">
          <div>
            ...
            <div className="flex items-center gap-2 text-gray-600 mb-10">
              ...
              <span className="text-sm">Drafting a freelance contract </span>
            </div>

            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8 max-w-3xl">
              <span className="text-tertiary">Get your </span>
              <span className="text-secondary-dark">freelance contract </span>
              <span className="text-tertiary ms-2">online</span>
            </h1>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-800">
                  Recommendation of a specialized lawyer
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">First telephone exchange free</p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  Fixed price quote obtained in less than 24 hours
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link
                href="/funnel/service_choices/1?source=%2Frediger-un-contrat%2Frediger-contrat-de-freelance"
