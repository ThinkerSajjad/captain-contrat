          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-gray-600 mb-10">
              ...
              <span className="text-sm">
                Drafting a subcontracting contract{" "}
              </span>
            </div>

            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8 max-w-3xl">
              <span className="text-tertiary">Have your  online </span>
              <span className="text-secondary-dark">
                Subcontracting Contract{" "}
              </span>
              {/* <span className="text-tertiary">drawn up online</span> */}
            </h1>
            <p className="text-gray-800 mb-4 lg:text-lg text-base">
              After an initial free exchange, obtain a fixed-price quote from a
              specialist lawyer in less than 24 hours.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link
                href="/funnel/service_choices/1?source=%2Frediger-un-contrat%2Frediger-contrat-de-sous-traitance"
