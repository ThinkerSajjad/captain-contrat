...
// Get your General Rental Conditions (GLC)
// After an initial free consultation, receive a fixed-price quote from a specialist lawyer in less than 24 hours.

// checkTake advantage of the recommendation of a specialized lawyer for your needs

// checkBenefit from a free initial exchange with this lawyer

// checkGet a fixed-price quote in less than 24 hours
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-center">
          <div>
            ...
            <p className="text-gray-800 mb-4 lg:text-lg text-base">
              After an initial free consultation, receive a fixed-price quote
              from a specialist lawyer in less than 24 hours.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-800">
                  Take advantage of the recommendation of a specialized lawyer
                  for your needs
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  Benefit from a free initial exchange with this lawyer
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  Get a fixed-price quote in less than 24 hours
                </p>
              </div>
            </div>
