        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-center">
          <div>
            ...
            <div className="flex items-center gap-2 text-gray-600 mb-10">
              ...
              <span className="text-sm">Drafting a fixed-term contract </span>
            </div>

            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8 max-w-3xl">
              <span className="text-tertiary">Get your </span>
              <span className="text-secondary-dark">fixed-term contract</span>
              <span className="text-tertiary ms-2">(CDD)</span>
            </h1>
            <p className="text-gray-800 mb-4 lg:text-lg text-base">
              A fixed-price service provided by a specialist lawyer and
              facilitated by our 100% online platform.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-800">Personalized support</p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  Document obtained in less than 72 hours
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link
                href="/funnel/service_choices/1?source=%2Fgestion-du-personnel%2Frediger-contrat-de-travail-a-duree-determinee"
