    ...
    <section className="py-8 md:py-20 bg-white">
      <PageContainer>
          <div className="mx-auto">
            ...
            The 4 steps to closing your company
            </h1>
            <p className="lg:mb-20 mb-10 text-center text-slate-700 font-medium lg:text-xl text-base">Entrust the closure of your company to experts</p>
              ...
              <div className="space-y-0 md:space-y-16">
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">2. Choice of service</span>
                      </p>
                      <p className="text-slate-700 font-medium leading-relaxed">
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pr-16 pl-8 md:pl-0 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">3. Processing the file</span>
                      </p>
                      <p className="text-slate-700 font-medium leading-relaxed mb-2">
                      Depending on your situation, a lawyer or attorney handles your case.
                      </p>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">4. Closure of the company</span>
                     
                      </p>
                      <p className="text-slate-700 font-medium leading-relaxed mb-2">
                      The procedure is complete, your company is dissolved or struck off.
                      </p>
