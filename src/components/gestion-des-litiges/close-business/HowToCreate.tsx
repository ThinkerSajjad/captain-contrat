...
import { closeBusinessGuide } from "@/data/closeBusinessGuide";
    ...
    <section className="py-16 bg-white" id="how-to-create">
      <PageContainer>
        <h2 className="text-3xl lg:text-5xl font-bold text-slate-800 mb-8 text-center">
          Understand everything about closing your business
        </h2>
          ...
          <div className="order-1 lg:order-2 lg:w-2/3">
            ...
            <div className="bg-white p-4 rounded-lg mb-8 border border-l-4 border-l-amber-500 border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <p className="font-semibold text-xl lg:text-2xl">Written by {closeBusinessGuide.author.name}, {closeBusinessGuide.author.title}</p>
                  <p className="text-gray-500 lg:text-sm text-xs">Updated: {closeBusinessGuide.author.date}</p>
                </div>
              </div>
