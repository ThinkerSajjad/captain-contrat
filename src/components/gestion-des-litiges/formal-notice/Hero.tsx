    ...
    <section className="relative py-12 bg-primary">
      <PageContainer>
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          ...
          <span className="text-sm">Formal notice</span>
        </div>

       
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8 max-w-3xl">
              <span className="text-tertiary">Get your personalized </span>
              <span className="text-secondary-dark">formal notice</span>
            </h1>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  <span className="font-semibold"> Used by  </span>2000+ entrepreneurs
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  <span className="font-semibold"> Easy to</span> complete and modify
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link href="/funnel/service_choices/1?source=%2Fcreer-entreprise%2Faide-au-choix-forme-juridique" className="bg-secondary-dark text-white px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition-all">
                Get my document
              </Link>
