    ...
    <section className="relative py-12 bg-primary">
      <PageContainer>
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          <Link href="/proteger-sa-societe" className="text-sm hover:underline">
            Protect my brand
          </Link>
          <ChevronRight className="w-4 h-4" />
          <span className="text-sm">Prior art search</span>
        </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8">
              <span className="text-tertiary">Run a </span>
              <span className="text-secondary-dark">prior art search</span>
              <span className="text-tertiary"> for your trademark</span>
            </h1>

            {/* Bullet Points */}
            <div className="space-y-4 mb-8">
              <p className="text-gray-700 lg:text-xl font-medium text-base">A fixed-price service provided by a specialist lawyer and facilitated by our 100% online platform.</p>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                Benefit from a platform and <strong>personalized support</strong>
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                Get your document in less than <strong>72 hours</strong>
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                Take advantage of a fixed-price quote <strong>tailored to your needs</strong>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link href="/funnel/service_choices/1?source=%2Fproteger-sa-societe%2Fdepot-de-marque-inpi-en-ligne" className="bg-secondary-dark text-white px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition-all">
                Check availability
              </Link>
