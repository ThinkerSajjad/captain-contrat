...
export function BrandProtectSteps() {
  return (
    <section className="py-8 md:py-20 bg-white">
      <PageContainer>
          <div className="mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl max-w-3xl mx-auto font-bold text-center text-slate-800 lg:mb-20 mb-10">
              Steps to protect your business with Captain Contrat
            </h2>
              ...
              <div className="space-y-0 md:space-y-16">
                  ...
                  <div className="md:w-1/2 md:pr-16 pl-8 md:pl-0 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">1. You explain your project to us </span>
                        <span className="text-secondary font-bold ml-2">5 minutes</span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">2. Depending on your needs, an expert lawyer will call you back</span>
                        <span className="text-secondary font-bold ml-2">24 hours</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pr-16 pl-8 md:pl-0 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">3. You receive a quote with transparent and fair prices</span>
                        <span className="text-secondary font-bold ml-2">24 hours</span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">4. You receive your company protection contracts or your trademark filing</span>
                        <span className="text-secondary font-bold ml-2">24 hours to 48 hours</span>
                      </p>
