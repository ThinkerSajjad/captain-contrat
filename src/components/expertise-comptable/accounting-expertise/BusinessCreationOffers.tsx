      ...
      <PageContainer>
        <div className="relative z-10 mx-auto">
          <h2 className="lg:text-5xl text-4xl font-bold text-center text-tertiary mb-6">
            A tailor-made service for square accounting{" "}
          </h2>
          ...
          {activeTab === "company" && (
            ...
            <div className="">
               ...
               */}
              <div className="relative bg-white rounded-xl border border-gray-800 md:w-1/2 lg:w-1/3 w-full mx-auto">
                ...
                <div className="bg-blue-100 min-h-20 p-6 overflow-hidden rounded-t-xl">
