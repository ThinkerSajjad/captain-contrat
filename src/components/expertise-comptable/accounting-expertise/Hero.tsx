        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-center">
          <div>
            ...
            <div className="flex items-center gap-2 text-gray-600 mb-10">
              ...
              <span className="text-sm">SCI accounting expertise</span>
            </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8">
              <span className="text-tertiary">Delegate </span>
              <span className="text-secondary-dark">the accounting</span>
              <span className="text-tertiary">
                {" "}
                of your SCI so you can focus on your business
              </span>
            </h1>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-800">
                  <span className="font-semibold">
                    Accountant and chartered accountant dedicated to monitoring
                    your activity
                  </span>{" "}
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  <span className="font-semibold">Intuitive software</span> to
                  centralize your receipts and expenses
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
