...
import sasuMockup from "../../../../public/images/business/sasu/img+mock-up-desktop_sasu.webp";
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-center">
          <div>
            ...
            <div className="flex items-center gap-2 text-gray-600 mb-10">
              <Link
                href="/avocat/droit-affaires"
                className="text-sm hover:underline"
              >
                Find a lawyer
              </Link>
              <ChevronRight className="w-4 h-4" />
              <span className="text-sm">Labor law attorney</span>
            </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8">
              <span className="text-tertiary">Find my </span>
              <span className="text-secondary-dark">labor law attorney </span>
            ...
            <div className="mb-8">
              <p>
                After an initial free exchange, obtain a fixed-price quote from
                a specialist lawyer in less than 24 hours.
              </p>
            </div>
