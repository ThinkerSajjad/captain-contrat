        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-center">
          <div>
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-8">
              ...
              <span className="text-secondary-dark">business law attorney</span>
            ...
            <div className="mb-8">
              <p>
                Responsive lawyers selected for their entrepreneurial expertise.
                All areas of business law covered.
              </p>
            </div>
