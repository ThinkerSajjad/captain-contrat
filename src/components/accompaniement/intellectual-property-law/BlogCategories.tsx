...
const categories = [
  {
    label: "Protection of creations",
    href: "/blog/protection-des-creations",
  },
  { label: "Disputes", href: "/blog/litiges" },
  {
    label: "Commercial contracts and general terms and conditions",
    href: "/blog/contrats-commerciaux-cgv",
  },
  {
    label: "Recruiting and managing employees",
    href: "/blog/recruter-gerer-ses-salaries",
  },
];
      ...
      <PageContainer>
        <div className="xl:px-24 px-0 mx-auto flex flex-col items-center">
          <h2 className="text-3xl md:text-5xl font-bold text-center text-tertiary font-crimson mb-10">
            Want to go further? Discover our blog
          </h2>
