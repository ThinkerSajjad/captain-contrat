      ...
      <PageContainer>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 max-w-3xl mx-auto">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Sophie Moreau</h3>
              <p className="text-gray-500 mb-4">Small Business Law Specialist</p>
              <p className="text-gray-700">
                Sophie Moreau specializes in small business law with a focus on EURL structures. 
                With over 10 years of experience advising solo entrepreneurs, she has helped 
                hundreds of business owners navigate the legal complexities of company creation. 
                Her expertise covers company structure optimization, tax planning, and legal 
                compliance for small businesses. She regularly contributes to legal publications 
                and speaks at entrepreneurship events.
              </p>
            </div>
          </div>
        </div>
