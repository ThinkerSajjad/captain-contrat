...
export function GuideContent() {
  const guideContents = [
    "Legal framework for annual accounts",
    "Preparation of financial statements",
    "Organizing the annual general meeting",
    "Required documentation and resolutions",
    "Filing accounts with the proper authorities",
    "Deadlines and penalties for non-compliance",
    "Simplified process for small companies"
  ];
