        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-start">
          <div className="lg:w-1/2">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-[#1E293B]">Transform your </span>
              <span className="text-[#F87171]">sole proprietorship or micro-enterprise</span>
              <span className="text-[#1E293B]"> into a sole proprietorship</span>
            </h1>

            <p className="text-gray-700 text-lg mb-6">
              Everything you need to know about transforming your business structure for optimal growth
            </p>

            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Understand the benefits of business transformation</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Navigate the legal and administrative process</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Optimize tax implications during the transition</span>
              </li>
            </ul>

            <p className="mb-2">Still have questions?</p>
            <Link href="/modifier-son-entreprise/transformation-sarl-en-sas" className="text-[#F87171] underline mb-8 inline-block">
          ...
          <div className="lg:w-[45%] w-full bg-white p-8 rounded-xl shadow-md self-center">
            <form className="space-y-6">
              ...
              >
                Get the transformation guide for free →
              </button>
