        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-start">
          <div className="lg:w-1/2">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-[#1E293B]">Everything you need to know about </span>
              <span className="text-[#F87171]">a manager's remuneration </span>
            </h1>

            <p className="text-gray-700 text-lg mb-6">
              Build your business creation project with peace of mind
            </p>

            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Confirm the choice of legal status</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>List all your administrative procedures</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Define your project budget</span>
              </li>
            </ul>
          ...
          <div className="lg:w-[45%] w-full bg-white p-8 rounded-xl shadow-md self-center">
            <form className="space-y-6">
              ...
              >
                Succeed in setting up my company →
              </button>
