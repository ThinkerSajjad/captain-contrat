...
const features = [
  {
    icon: lawyerIcon,
    title: "Written by solo entrepreneur experts"
  },
  {
    icon: downloadIcon,
      ...
      <PageContainer>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 max-w-3xl mx-auto">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Antoine Martin</h3>
              <p className="text-gray-500 mb-4">Solo Entrepreneurship Specialist</p>
              <p className="text-gray-700">
                Antoine Martin is a specialist in solo entrepreneurship and SASU structures. 
                After founding his own SASU and growing it successfully, he now advises other 
                solo entrepreneurs on optimizing their legal and tax structure. His expertise 
                spans company creation, tax optimization, and social security regimes for company 
                presidents. He regularly speaks at entrepreneurship conferences and contributes to 
