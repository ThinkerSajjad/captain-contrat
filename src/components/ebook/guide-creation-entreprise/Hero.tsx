        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-start">
          <div className="lg:w-1/2">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-[#1E293B]">Anticipate and control </span>
              <span className="text-[#F87171]">the registration of your company</span>
            </h1>

            <p className="text-gray-700 text-lg mb-6">
              Master all the administrative steps to properly register your business
            </p>

            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Prepare all required documents</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Understand the registration process</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
            ...
            <Link href="/resources" className="text-[#F87171] underline mb-8 inline-block">
              Discover all our resources for business registration
            </Link>
          ...
          <div className="lg:w-[45%] w-full bg-white p-8 rounded-xl shadow-md self-center">
            <form className="space-y-6">
              ...
              >
                Get the registration guide for free →
              </button>
