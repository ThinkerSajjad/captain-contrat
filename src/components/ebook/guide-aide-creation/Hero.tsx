        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 items-start">
          <div className="lg:w-1/2">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-[#1E293B]">Guide to assistance for </span>
              <span className="text-[#F87171]">business creation and takeover</span>
            </h1>

            <p className="text-gray-700 text-lg mb-6">
              Discover all available support and financing options for entrepreneurs
            </p>

            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Find the right financial assistance</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Understand eligibility criteria</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#F87171]">✓</span>
                <span>Optimize your financing strategy</span>
              </li>
            </ul>

            <p className="mb-2">Still have questions?</p>
            <Link href="/resources" className="text-[#F87171] underline mb-8 inline-block">
              Discover all our resources for business financing
            </Link>
          ...
          <div className="lg:w-[45%] w-full bg-white p-8 rounded-xl shadow-md self-center">
            <form className="space-y-6">
              ...
              >
                Get the financing guide for free →
              </button>
