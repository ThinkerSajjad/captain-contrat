      ...
      <PageContainer>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 max-w-3xl mx-auto">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Pierre Dupont</h3>
              <p className="text-gray-500 mb-4">Business Law Expert</p>
              <p className="text-gray-700">
                With over 15 years of experience in business law, Pierre has helped hundreds of 
                entrepreneurs start their businesses. After working in several prestigious law firms, 
                he now specializes in supporting startups and small businesses through their creation 
                process. His practical approach and clear explanations have made him a reference in 
