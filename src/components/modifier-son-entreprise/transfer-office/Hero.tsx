    ...
    <section className="relative py-12 bg-primary">
      <PageContainer>
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          ...
          <span className="text-sm">Transfer of registered office</span>
        </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-tertiary">Transfer your </span>
              <span className="text-secondary-dark">registered office</span>
              <span className="text-tertiary"> online easily</span>
            </h1>
            <p className="text-gray-700 mb-8 lg:text-lg text-base">Transfer your company's head office in just a few clicks, with the support of your dedicated lawyer at all times.</p>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link href="/funnel/service_choices/1?source=%2Fmodifier-son-entreprise%2Fmodification-objet-social" className="bg-secondary-dark text-white px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition-all">
                Transfer my registered office
              </Link>
