    ...
    <section className="relative py-12 bg-primary">
      <PageContainer>
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          ...
          <span className="text-sm">Change of corporate purpose</span>
        </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-tertiary">Change your  </span>
              <span className="text-secondary-dark">company's corporate</span>
              <span className="text-tertiary"> purpose</span>
            </h1>
            <p className="text-gray-700 mb-8 lg:text-lg text-base">Change your company's corporate purpose in just a few clicks, with the support of your dedicated lawyer at all times.</p>
