    ...
    <section className="relative py-12 bg-primary">
      <PageContainer>
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          ...
          <span className="text-sm">Approval of your accounts</span>
        </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-tertiary">Complete your </span>
              <span className="text-secondary-dark">account approval </span>
              <span className="text-tertiary"> online </span>
            </h1>
            <p className="text-gray-700 mb-8 lg:text-lg text-base">Proceed with your account approval in just a few clicks, with the support of your dedicated legal advisor at all times.</p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-800">
                  <span className="font-semibold">Trusted partner </span> with personalized support
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  <span className="font-semibold">Intuitive platform </span> your file validated and sent in less than 24 hours
                </p>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link href="/funnel/service_choices/1?source=%2Fmodifier-son-entreprise%2Fapprobation-comptes-en-ligne" className="bg-secondary-dark text-white px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition-all">
                Approval of your accounts
              </Link>
