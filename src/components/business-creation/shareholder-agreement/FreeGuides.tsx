...
import LegalGuide from "../../../../public/images/business/shareholder-agreement/pacte-associe-389x485px.png";
        ...
        <div className="bg-blue-100 rounded-xl p-8 flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/4 w-full flex justify-center">
            <div className="relative">
              <Image 
                src={LegalGuide} 
                alt="micro-entreprise Legal Guide" 
          ...
          <div className="md:w-3/4 w-full">
            ...
            Need to create your micro-entreprise?
