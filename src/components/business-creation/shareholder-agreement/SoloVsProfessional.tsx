    ...
    <section className="py-16 bg-white">
      <PageContainer>
        <h2 className="lg:text-4xl text-3xl font-bold text-center text-tertiary lg:mb-12 mb-8">
          Micro-entreprise: solo creation or professional support?
        </h2>
        ...
        <div className="mt-10 flex justify-center">
          <Link 
            href="/funnel/service_choices/1?source=%2Fcreer-entreprise%2Frediger-pacte-associes" 
