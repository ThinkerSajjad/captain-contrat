...
import Mockup from "../../../../public/images/business/micro-business/img+mock-up-desktop_micro.webp";
    ...
    <section className="relative py-12 bg-primary">
      <PageContainer>
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          ...
          <span className="text-sm">Creation of micro-entreprise</span>
        </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-8">
              <span className="text-tertiary">Create your </span>
              <span className="text-secondary-dark">micro-business</span>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link href="/funnel/service_choices/1?source=%2Fcreer-entreprise%2Fcreer-micro-entreprise" className="bg-secondary-dark text-white px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition-all">
                Create my micro-entreprise
              </Link>
