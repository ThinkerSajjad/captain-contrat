        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          ...
          <span className="text-sm">Creation of SASU</span>
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-8">
              <span className="text-tertiary">Create a </span>
              <span className="text-secondary-dark">SASU</span>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start gap-2">
                <div className="mt-1 bg-secondary-dark rounded-full p-1 w-4 h-4"></div>
                <p className="text-gray-800">
                  <span className="font-semibold">Affordable prices :</span> offers starting at just €0
                </p>
              </div>
            </div>
