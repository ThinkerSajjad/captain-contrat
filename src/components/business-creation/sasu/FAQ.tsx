...
const faqs = [
  ...
  },
  {
    ...
    answer: (
        <div className="space-y-4">
            <p>To expect :</p>
            <p>Costs <strong>related to legal and administrative formalities</strong>:</p>
            <ul className="list-disc pl-5 space-y-2">
                <li>The costs of publishing a legal notice (around €200);</li>
                <li>Submitting your registration file to the Trade and Companies Register (around €40);</li>
                <li>Registration in the register of beneficial owners (approximately €25).</li>
            </ul>
  ...
  },
  {
    ...
    answer: "There is no minimum contribution required to establish a SASU. Thus, it is possible to create a SASU with a share capital of 1 euro. However, entrepreneurs generally prefer a share capital of around 1,000 euros to gain greater credibility with banks and their business partners.  ",
  },
  {
    question: "Can you open a SASU alone?",
    answer: "Yes, a SASU is a so-called single-member company (formed by a single shareholder). Therefore, there can only be one partner in a SASU. However, it is possible to create a SAS (simplified joint-stock company) with multiple partners.",
  },
  {
    ...
    answer: (
        <div className="space-y-4">
            ...
            <p><strong>Step 1: drafting the statutes</strong></p>
            <p>The statutes are strategic for your company because they set the operating rules:</p>
            <ul className="list-disc pl-5 space-y-2">
            ...
            <p><strong>Step 2: Deposit of share capital</strong></p>
            <p>As a reminder, the share capital of the SASU is made up of your contributions:</p>
            <ul className="list-disc pl-5 space-y-2">
                <li>In cash (sum of money)</li>
                <li>And in kind (movable or immovable property).</li>
            </ul>
            <p><strong>Please note:</strong> the contribution of industry (know-how or skills) does not contribute to the creation of share capital.</p>
            <p>The share capital is deposited before the articles of association are signed and the company is registered. It must be made to a credit institution or notary by bank transfer, check, or cash.</p>
            <p><strong>Step 3: publication of the legal notice</strong></p>
            <p>The publication of the notice of incorporation of your SASU must be completed before:</p>
            <ul className="list-disc pl-5 space-y-2">
            ...
            <p><strong>Step 4: transmitting the file to the Single Window</strong></p>
            <p>The One-Stop Shop is a platform that allows you to complete business creation formalities online. You will need to complete a single form and submit your supporting documents to the website procedures.inpi.fr .</p>
            <p><strong>Step 5: registration of the SASU</strong></p>
            <p>This is the finalization of your formality. If your file is duly completed, the registry will be able to proceed with the registration of your SASU in the national business register (Registre national des entreprises) and in the trade and companies register (RCS: Registre du commerce et des sociétés). You will then receive a document with your Siren number.</p>
        </div>
  ...
  },
  {
    ...
    answer: (
        <div className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2">
                <li><strong>During a capital increase</strong> (with the entry of one or more partners),</li>
                <li><strong>In the event </strong> of transfer by the sole shareholder of all or part of his shares to several new shareholders</li>
                <li><strong>Following the death of the sole shareholder</strong> and the division of his shares between several people. </li>
            </ul>
            <p>This change <strong>does not constitute a business transformation</strong> since it is the same legal form (the SASU is a single-member SAS).</p>
            <p><strong>The amendment of the statutes</strong> is <strong>not obligatory</strong> , if the statutes have been drafted in such a way as to anticipate this eventuality by providing for operation and organization with several partners (if they already contain, for example, an approval, pre-emption, exclusion clause, etc.).</p>
            <p>However, steps will need to be taken with the registry to have the SAS listed on the Kbis and you will need to publish it in a legal notices journal. Internal formalities will need to be completed, such as a management report and minutes of the meeting (called a sole shareholder decision).</p>
            <p>Finally, share transfers must be registered with the Business Tax Service (SIE) and registration fees will be payable.</p>
  ...
  },
  {
    ...
    answer: (
        <div className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2">
                <li>freedom in drafting the statutes and in organizing the operation of the company;</li>
                <li>the absence of turnover thresholds;</li>
                <li>the assimilated employee regime and affiliation to the General Social Security Regime.</li>
            </ul>
            <p>Do you have questions about choosing between a SASU (Single-Sector Enterprise) and a micro-enterprise? Check out our article: Self-employed or SASU: Which status should you choose?</p>
        </div>
    ),
  },
  {
    ...
    answer: (
        <div className="space-y-4">
            <p>Registering your business can be complex due to the various legal documents required. Indeed, you must submit a complete SASU creation file to avoid rejection by the registry. The file must include:</p>
            <ul className="list-disc pl-5 space-y-2">
                <li>two copies of the statutes;</li>
                <li>a copy of the published legal notice (certificate of publication);</li>
            ...
            <p>As you will have understood, these procedures can be complex, but Captain Contrat offers to take care of these legal formalities to create your SASU .</p>
        </div>
    ),
  },
  {
    ...
    answer: (
        <div className="space-y-4">
            <p>Creating a SASU online involves several steps, including drafting the articles of association, publishing a notice of incorporation in a legal notices journal, and registering with the receipt of the Kbis.</p>
            <p>On average, the time to create your SASU online is between one week and one month.</p>
            <p>To save time on all the key steps , benefit from the support of Captain Contrat.</p>
        </div>
    ),
  },
  {
    ...
    answer: (
        <div className="space-y-4">
            <p>There are two types of social charges to take into account before creating a SASU:</p>
            <ul className="list-disc pl-5 space-y-2">
                <li>employee and employer contributions attached to the remuneration of the manager (also called president in SAS and SASU) and any employees;</li>
  ...
  },
{
    ...
    answer: (
        <div className="space-y-4">
            <p>Although the EURL and the SASU have in common the fact that they are single-member companies (one partner), there are significant differences between these two structures:</p>
            <ul className="list-disc pl-5 space-y-2">
            ...
            <p><strong>Differences in social protection</strong></p>
            <p>By opting for the role of President of SASU, you will be considered an employee, and therefore affiliated with the general Social Security scheme (if you pay yourself a salary).</p>
            <p>Conversely, the sole manager of an EURL is a self-employed worker (TNS).</p>
            <p>To choose between these two companies, you will need to determine what matters most to you:</p>
            <ul className="list-disc pl-5 space-y-2">
 ...
 {
    question: "What are the differences between a SASU and a sole proprietorship (EI)?",
    answer: (
        <div className="space-y-4">
            ...
            <p>The creation of a SASU gives rise to a legal entity separate from the person who manages it and which has its own assets.</p>

            <p>The sole proprietorship (EI), on the other hand, is not separate from the entrepreneur who creates it. The entrepreneur carries out his activity in his own name.</p>

            <p>The SASU allows you to distinguish your assets and your liability will be limited to the amounts of your contributions .</p>
            ...
            <p>The sole proprietorship has the option of choosing the advantageous micro-enterprise regime. However, this regime is subject to turnover ceilings: €77,700 for services (BIC or BNC) and €188,700 for sales activities (of goods, objects, supplies, etc.).</p>

            <p>The sole proprietorship has the option of choosing the advantageous micro-enterprise regime. However, this regime is subject to turnover ceilings: €77,700 for services (BIC or BNC) and €188,700 for sales activities (of goods, objects, supplies, etc.).</p>

            <p>This choice can therefore prove advantageous for entrepreneurs who do not particularly wish to develop or grow their business.</p>

            <p>These ceilings do not exist in SASUs. This structure is therefore more suitable for ambitious projects. </p>
        </div>
    ),
  },
  {
    question: "Can I be an employee of my SASU?",
    answer: "The sole shareholder of a SASU cannot be an employee of the SASU, as there must be a relationship of subordination between the employee and the company. However, this relationship of subordination cannot be characterized in a SASU since the sole shareholder has all the powers. On the other hand, the shareholder who is also the president of the SASU can be compensated for his corporate mandate. "
  },
  {
    question: "What is the status of a SASU manager?",
    answer: "The president of a SASU benefits from the social security system for assimilated employees. This system has the advantage of being protective, but it is relatively expensive for the company (around 80% of net salary). It offers the president of the SASU social security protection similar to that of an employee (with the exception of unemployment insurance)."
  },
  {
  ...
  },
  {
    ...
    answer: "By default, the SASU is subject to corporate income tax (IS). Profits are taxed at a fixed rate of 25%. However, SMEs can benefit from a reduced rate of 15% on the first €42,500. Furthermore, the sole shareholder may decide to opt for income tax for the first 5 financial years. In this case, profits are taxed directly in the hands of the sole shareholder according to the income tax scale brackets. "
  },
  {
    question: "What is the social security system for SASU?",
    answer: "The president of a SASU is considered an assimilated employee. This means that he or she benefits from social security protection comparable to that of an employee (with the exception of unemployment insurance). This social security system costs the SASU relatively little (approximately 80% of net salary). Conversely, the manager of an EURL is a self-employed worker. This regime is less expensive (around 45% of net salary) but social protection is weaker (particularly regarding pension contributions). On the other hand, the manager of an EURL must pay social security contributions on dividends, which is not the case for the president of a SASU."
  },
