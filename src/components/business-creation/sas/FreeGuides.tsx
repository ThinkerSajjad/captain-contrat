...
import LegalGuide from "../../../../public/images/business/sas/crea-SAS-389x485px.png";
      ...
      <PageContainer>
        ...
        <div className="bg-blue-100 rounded-xl p-8 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-3/4 w-full">
            ...
            Download our free guide to learn everything about creating an SAS
            </h3>
            <p className="text-gray-700 mb-6">
            Need to create your Simplified Joint Stock Company (SAS)?
