...
const testimonials = [
  {
    ...
    value: "81%",
    description:
      "of our customers are satisfied after their order with Captain Contrat.",
  },
  {
    type: "testimonial",
    name: "Sandrine R.",
      ...
      <PageContainer>
        <div className="w-full mx-auto flex justify-center">
          <h2 className="text-3xl w-fit lg:text-5xl font-bold text-center mx-6 md:mx-0 text-tertiary font-crimson lg:mb-12 mb-8 relative">
            Why do entrepreneurs trust our lawyers?
            <span className="absolute -top-2 md:-right-10 -right-2 inline-block">
              ...
              >
                <path
                  d="M58 2C58 2 54.5 7.5 46 12"
                  stroke="#F27C7C"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                />
                <path
                  d="M44 2C44 2 42.5 6.5 38 10"
                  stroke="#F27C7C"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                />
                <path
                  d="M60 14C60 14 56.5 16.5 52 18"
                  stroke="#F27C7C"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                />
        ...
        <div className="hidden md:grid md:grid-cols-2 md:grid-rows-3 lg:grid-cols-3 lg:grid-rows-2 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="bg-[#eaf1f8] rounded-2xl flex flex-col justify-center items-center p-8 h-full min-h-[220px]">
            <div className="text-[72px] leading-none font-bold text-accent mb-2">
              {testimonials[0].value}
            </div>
          ...
          <div className="bg-[#eaf1f8] rounded-2xl flex flex-col justify-between p-8 h-full min-h-[220px]">
            <div className="flex items-center mb-2">
              <div className="font-bold text-xl text-tertiary mr-3">
                {testimonials[2].name}
              </div>
            ...
            <div className="text-sm mb-1 text-tertiary font-semibold">
              {testimonials[2].role}
            </div>
        ...
        <div className="md:hidden relative">
          ...
          >
            {testimonials.map((testimonial, idx) => (
              <div
                key={idx}
                className={`w-[80vw] h-auto flex-shrink-0 rounded-2xl snap-center ${
                  testimonial.dark
                    ? "bg-tertiary text-white"
                    : "bg-[#eaf1f8] text-tertiary"
              ...
              >
                ...
                <div
                  className={testimonial.image ? "relative z-10 p-6" : "p-6"}
                >
                  {testimonial.type === "stat" ? (
                    <>
                      <div className="text-[72px] leading-none text-center font-bold text-accent mb-2">
                        {testimonial.value}
                      </div>
                      <div className="text-base text-gray-700 text-center">
