        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-700">
              <span className="font-semibold">companies</span> created thanks to
              our lawyers
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-700">
              <span className="font-semibold">projects</span> carried out with
              Captain Contrat
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-700">
              <span className="font-semibold">entrepreneurs</span> subscribed
              and supported
              <br />
              on a daily basis
            </div>
            ...
            <div className="flex items-center">
              <div className="flex">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 2a1 1 0 011 1v6.5l3.5-2a1 1 0 011.5.866V14.5a1 1 0 01-1.5.866L11 13.366V18a1 1 0 11-2 0V2a1 1 0 011-1z"
                    clipRule="evenodd"
                  />
                </svg>
              </div>
