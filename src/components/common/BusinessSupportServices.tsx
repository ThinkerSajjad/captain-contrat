    ...
    <section className="py-8 md:py-20 bg-white">
      <PageContainer>
        <div className="mx-auto relative">
          ...
          <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-3 gap-6 mx-auto">
            {/* Expertise card */}
            <div className="bg-primary rounded-xl p-6 flex flex-col items-center">
              ...
              <div className="text-slate-700">
                <p className="mb-2">
                  Our lawyers have all been carefully selected, and we have
                  worked with them for several years. Our teams know them well
                  and will be able to direct you to the most suitable lawyer
            ...
            <div className="bg-primary rounded-xl p-6 flex flex-col items-center">
              ...
              <div className="text-slate-700">
                <p className="mb-2">
                  Before providing a quote, the lawyer takes the time to discuss
                  your needs with you and advise you on the best options. During
                  the consultation, your lawyer is available by email or phone.
                </p>
              </div>
            </div>

            {/* Simplicity filing card */}
            <div className="bg-primary rounded-xl p-6 flex flex-col items-center">
              <div className="mb-6">
              ...
              <div className="text-slate-700">
                <p className="mb-2">
                  To streamline your client experience as much as possible,
                  you'll have access to an online platform to centralize your
                  documents. You'll be able to communicate directly with your
                  lawyer and our teams.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="md:hidden relative">
            ...
            >
              ...
              <div className="w-[80vw] flex-shrink-0 snap-start bg-primary rounded-xl p-6 flex flex-col items-center">
                ...
                <div className="text-slate-700">
                  <p className="mb-2">
                    Before providing a quote, the lawyer takes the time to
                    discuss your needs with you and advise you on the best
                    options. During the consultation, your lawyer is available
                    by email or phone.
                  </p>
                </div>
              </div>
