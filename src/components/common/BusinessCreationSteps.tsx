          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="space-y-0 md:space-y-16">
              ...
              <div className="relative flex flex-col md:flex-row items-center">
                {/* Find a lawyer in 5 minutes - first segment */}
                  ...
                  <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                    <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                      <span className="text-slate-800">
                        Find a lawyer in{" "}
                        <span className="text-secondary">5 minutes</span>
                      </span>
                    </p>
                    <p className="text-slate-700 font-medium leading-relaxed">
                      Answer a few questions to clarify your needs. We'll select
                      the most suitable lawyer and contact you to schedule an
                      appointment. Your lawyer will prepare your consultation
              ...
              {/* Step 2 - Right side */}
              <div className="relative flex flex-col md:flex-row items-center">
                {/* Telephone exchange - middle segment */}
                ...
                <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                  <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                    ...
                    <p className="text-slate-700 font-medium leading-relaxed">
                      During this initial 15- to 30-minute meeting, your lawyer
                      takes the time to assess your needs. This meeting usually
              ...
              <div className="relative flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pr-16 pl-8 md:pl-0 mb-8 md:mb-0">
                  <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                    <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                      <span className="text-slate-800">
                        The lawyer will send you a quote within
                        <span className="text-secondary"> 24 hours</span>
                      </span>
                    </p>
                    <p className="text-slate-700 font-medium leading-relaxed mb-2">
                      At the end of your discussion, the lawyer will send you a
                      quote at a fixed price. This price includes the entire
                      service and unlimited communication with the lawyer.
                    </p>
                  </div>
                </div>
                {/* Timeline dot - mobile left, desktop center */}
              ...
              <div className="relative flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                  <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                    <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                      <span className="text-slate-800">
                        The lawyer performs the{" "}
                        <span className="text-secondary">service</span>
                      </span>
                    </p>
                    <p className="text-slate-700 font-medium leading-relaxed mb-2">
                      If you accept and pay the quote, the lawyer will provide
                      the service: advice, drafting or proofreading of
                      documents, etc.
                    </p>
                  </div>
                </div>
