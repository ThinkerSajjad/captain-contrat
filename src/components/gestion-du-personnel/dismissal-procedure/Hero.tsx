    ...
    <section className="relative py-12 bg-primary">
      <PageContainer>
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-10">
          ...
          <span className="text-sm">Dismissal procedure</span>
        </div>
            {/* Heading */}
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-tertiary">Complete your </span>
              <span className="text-secondary-dark">dismissal procedure</span>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link href="/funnel/service_choices/1?source=%2Fgestion-du-personnel%2Fprocedure-de-licenciement" className="bg-secondary-dark text-white px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition-all">
