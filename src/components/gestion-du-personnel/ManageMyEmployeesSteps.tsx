...
export function ManageMyEmployeesSteps() {
  return (
    <section className="py-8 md:py-20 bg-white">
      <PageContainer>
          <div className="mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl max-w-3xl mx-auto font-bold text-center text-slate-800 mb-3">
            Steps to manage your employees
            </h2>
            <p className="text-center text-slate-700 font-medium leading-relaxed lg:mb-20 mb-10 lg:text-2xl text-lg">
            ...
            <div className="relative max-w-6xl mx-auto">
              ...
              <div className="space-y-0 md:space-y-16">
                {/* Step 1 - Left side */}
                <div className="relative flex flex-col md:flex-row w-full items-stretch">
                  ...
                  <div className="md:w-1/2 md:pr-16 pl-8 md:pl-0 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      ...
                      Our questionnaire allows us to understand your needs.
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">2. Telephone exchange</span>
                      </p>
                      <p className="text-slate-700 font-medium leading-relaxed">
                      Our coach will choose the lawyer best suited to your situation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pr-16 pl-8 md:pl-0 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">3. Call and obtain the quote</span>
                      </p>
                      <p className="text-slate-700 font-medium leading-relaxed mb-2">
                      After a free exchange, the lawyer will offer you a fixed-price quote.
                      </p>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 pl-8 mb-8 md:mb-0">
                    <div className="text-left md:text-left bg-lightPrimary lg:p-6 p-5 rounded-xl">
                      <p className="text-xl md:text-2xl font-semibold mb-3 text-slate-700">
                        <span className="text-slate-800">4. Unlimited exchanges</span>
                      </p>
                      <p className="text-slate-700 font-medium leading-relaxed mb-2">
