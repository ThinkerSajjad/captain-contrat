...
import LegalGuide from "../../../../public/images/business/eurl/crea-EURL.png";
      ...
      <PageContainer>
        ...
        <div className="bg-blue-100 rounded-xl p-8 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-3/4 w-full">
            ...
            Need help? Get our guide delivered to your inbox immediately.
            </h3>
            <p className="text-gray-700 mb-6">
            Our guide will help you understand the mutual termination procedure and the conditions for receiving unemployment benefits.
            </p>
            <Link 
              href="#download-guide" 
